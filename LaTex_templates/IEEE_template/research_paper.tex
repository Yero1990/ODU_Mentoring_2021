...
justification for your topic before it has been explicitly stated. Example of inserting a Figure, See Fig.\ref{}.
...
Write 2-3 sentences explaining what this layer does.
...
You are writing your paper, see Ref.\cite{my_article}
...
% ------ ALTERNATIVE (BETTER WAY) OF DOING REFERENCES --------

% INCLUDE a references.bib file with all your references (you don;t have to worry about formatting, only the tyoe of reference you need)
