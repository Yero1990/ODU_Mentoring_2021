...
`First Week: July 26 - July 30, 2021` <br>
...
* Help out students install and setup Python and Github if necessary <br> 
  ( see [python-installation](https://www.wikihow.com/Install-Python#Mac) and [github-installation](https://github.com/git-guides/install-git) )
...
see github-examples: [fork-and-branch git workflow](https://blog.scottlowe.org/2015/01/27/using-fork-branch-git-workflow/)
