 ...
 * I have added a compressed (Week_5.zip) directory which you can move to your respective working directories and de-compress the folder. See the instructions in the README.md file inside this directory as well as specific instructions on how to run the codes in the `./scripts` directory.
